...
syn keyword	cOperator	sizeof_bytes sizeof_bits points points_range points_if skip_bytes align_bytes set_bytes set_bits from_base_bits assert virtual
syn keyword	cType		int long short char void
syn keyword	cType		bool u1 u16 u8 u32 u64 s16 s8 s32 s64
syn keyword	cStructure	type union enum typedef
syn keyword	cStorageClass	const as

syn keyword	cConstant	__FROM_OS_BDEV_BYTES __FROM_OS_BDEV_BLOCK_BYTES
